...
public class QTasKagıtMakas2 {
	...
	public static void main(String[] args) {
		...
		// kagit >tas
		/*
		 * Oncelikle kullanicidan secim alabilmek icin Scanner yapiyoruz. Ardindan main
		 * fonksiyonumuzda kullanicinin ve bilgisayarin puanlarini tanimliyoruz. While
		 * dongumuzun icerisinde kullanicidan aldigimiz secimi “secim” isimli degiskene
		 * atiyoruz. Bilgisayarin secimini ise Math.random methodunu kullanarak
		 * aliyoruz. Math.random()*3 diyerek bilgisayara 0 ile 3 arasinda bir rastgele
		 * sayi urettiriyoruz. Ve secimimiz ile bilgisayarin secimini karsilastirip
		 * sonuclarini yaziyoruz. En sonda da kullaniciya oyuna devam etmek isteyip
		 * istemedigini soruyoruz, eger istiyorsa dongumuz en bastan calisiyor,
		 * istemiyorsa da cikis yapiyor.
		 */
		...
		while (cevap.equalsIgnoreCase("EVET")) {
			...
			if (count == 1) {		//Açılış ekranı sadece bir kez gelmesi için
			...
			if (kullanici_puani == 3) {
				...
				if (cevap.equalsIgnoreCase("Evet")) {
					...
					count = 1; //count 1 yaparak en başa gönderiyor
				}
