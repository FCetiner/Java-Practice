...
class P01_JavaBankAtm {
   /*      ATM
        ...
        Bakiye sorgula, para yatirma, para çekme, para gÃ¶nderme, sifre değiştirme ve cikis.

        Para çekme ve para gonderme işleminde mevcut bakiyeden buyuk para çekilemez,
        Para gÃ¶nderme işleminde istenen iban TR ile baslamali ve toplam 26 karakterli olmali, eger değilse menÃ¼ ekranina geri donsun.
