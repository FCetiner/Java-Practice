...
public class A_StringMethods {
	...
	public static void main(String[] args) {
        ...
        int index = text.indexOf("o"); // int deðiþkene atanabilir. kÃ¼çÃ¼k o harfi
        ...
        /** lastIndexOf()
         *  String içinde aranan karakter(ler)in sondan itibaren ilk indexini varÄ±r
         *  indexOf un sondan olan hali fakat index numaralarÄ± deðiþmez.
         */
         ...
         * karakterlerin sÄ±rasÄ± 0 dan baþlar, buna index denir.
        ...
        /** ReplaceFirst
        * Replace ile aynÄ± sadece ilk bulunanÄ± deðiþtirir
         */
         ...
         * bir stringin içerisinde karakter(ler)in var olup olmadÄ±ðÄ±nÄ± kontrol eder.
         * Sonuc boolean dir.
         *
         * equals()
         * 2 String metnin birbirine esit olup olmadigina bakar. bÃ¼yÃ¼k kÃ¼çÃ¼k harf farkÄ± vardÄ±r. Sonuc boolean dir.
         *
         * equalsIgnorecase()
